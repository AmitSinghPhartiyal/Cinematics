...
const imgPath = "https://image.tmdb.org/t/p/w500/"
 class PopularPeople extends Component {
	...
	componentDidMount(){
		this.props.fetchData('https://api.themoviedb.org/3/person/popular?api_key=55032e2af54d05c1326b26b0bf830b60&language=en-US&page=2');
	}
	changeView  = () => {
  ...
  render(){
  	if(this.props.loading){
		 	return(
		 		<ActivityIndicator
		 			animating = { true }
		 			style = {{ flex:1,height:120,marginTop:height*0.35,backgroundColor:'#333' }}
		 			size = 'large'
		 			color = '#76d46e'
		 		/>
		 	)
	    ...
	    return(
	    	<View style ={{ flex:1,backgroundColor:'#fff'}}>
	    		<View style ={{ flex:0.1,flexDirection:'row',backgroundColor:'#333'}}>
