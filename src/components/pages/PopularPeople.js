...
import { IMAGE_PATH,COLORS } from "../constant/index"
  ...
  render() {
    if (this.props.loading) {
      return (
        <ActivityIndicator
          animating={true}
          style={{ flex: 1, height: 120, marginTop: height * 0.30 }}
          size="large"
      ...
      return (
        <View style={{ flex: 1, backgroundColor: COLORS.WHITE }}>
          <View
            style={{ flex: 0.1, flexDirection: "row", backgroundColor: COLORS.PRIMARY }}
          >
            <View
              style={{
                flex: 0.2,
            ...
            >
              ...
              >
                <Icon name="bars" style={{ color: COLORS.WHITE, fontSize: 20 }} />
              </TouchableOpacity>
            </View>
            ...
            >
              <TouchableOpacity onPress={() => Actions.Search()}>
                <Icon name="search" style={{ color: COLORS.WHITE, fontSize: 20 }} />
              </TouchableOpacity>
            </View>
          </View>
